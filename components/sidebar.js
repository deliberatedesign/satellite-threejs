L.mapbox.accessToken = 'pk.eyJ1IjoicGV0ZXJxbGl1IiwiYSI6ImNqdHJqdG92OTBkNTg0M3BsNDY0d3NudWcifQ.0z4ov_viFE-yBMSijQpOhQ';

// instantiate viewshed map
var viewshed = L.mapbox.map('viewshed', 'mapbox.satellite', {
    minZoom: 0,
    maxZoom:0,
    zoomControl:false
})
